...
@section('title', __('settings.add_governorate'))
@section('breadcrumb', __('settings.add_governorate'))

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">{{ __('settings.add_governorate') }}</h1>
    </div>
...
<form action="{{ route('settings.governorates.store') }}" method="POST">
    @csrf
    <div class="card mb-5">
        <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="flex items-center">
                <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                    ...
                    <input type="checkbox" name="status" value="1" class="sr-only peer" @checked(old('status', true))>
