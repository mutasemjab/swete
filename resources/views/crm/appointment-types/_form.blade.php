...
<div class="card mb-5">
    ...
    <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
            ...
            <input type="text" name="name_en" value="{{ old('name_en', $type?->name_en) }}" dir="ltr"
        ...
        <div class="flex items-center">
            <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                ...
                <input type="checkbox" name="status" value="1" class="sr-only peer" @checked(old('status', $type->status ?? true))>
