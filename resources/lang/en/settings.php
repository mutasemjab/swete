...
return [
    ...
    'branch_quote_images'         => 'Price Quote Print Images',
    'branch_quote_images_hint'    => 'These images are used as the header and first-page content when printing price quotes issued from this branch.',
    'branch_quote_header_images'  => 'Header Images (shown at the top of every page)',
    'branch_quote_header_image'   => 'Header Image',
    'branch_quote_body_images'    => 'Additional Images (first page only)',
    'branch_quote_body_image'     => 'Additional Image',
    'is_main'               => 'Main Branch',
