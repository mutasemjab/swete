...
return [
    ...
    'branch_logo'            => 'الشعار الأساسي',
    'branch_logo_secondary'  => 'الشعار الثانوي',
    'branch_logos_hint'      => 'تظهر هذه الشعارات في ترويسة المستندات القابلة للطباعة مثل طلبات الشراء.',
    'current_logo'           => 'الشعار الحالي',
    'branch_quote_images'         => 'صور طباعة عرض السعر',
    'branch_quote_images_hint'    => 'تُستخدم هذه الصور كترويسة ومحتوى الصفحة الأولى عند طباعة عروض الأسعار الصادرة من هذا الفرع.',
    'branch_quote_header_images'  => 'صور الترويسة (تظهر أعلى كل صفحة)',
    'branch_quote_header_image'   => 'صورة الترويسة',
    'branch_quote_body_images'    => 'صور إضافية (الصفحة الأولى فقط)',
    'branch_quote_body_image'     => 'صورة إضافية',
    'is_main'               => 'فرع رئيسي',
