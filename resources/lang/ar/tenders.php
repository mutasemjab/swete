...
return [
    ...
    'module_desc' => 'إدارة العطاءات ونداءات الخدمة وتتبع حالتها',

    // ── Sidebar sections ─────────────────────────────────────────────────────
    'section_management'     => 'العطاءات',
    'section_service_calls'  => 'نداءات الخدمة',

    // ── Sidebar items ────────────────────────────────────────────────────────
    'nav_list' => 'قائمة العطاءات',
    'nav_add'  => 'إضافة عطاء',
    'nav_service_calls_list' => 'قائمة نداءات الخدمة',
    'nav_service_calls_add'  => 'إضافة نداء خدمة',

    // ── Types (shared: tender / service_call) ────────────────────────────────
    'type_tender'               => 'عطاء',
    'type_service_call'         => 'نداء خدمة',
    'type_tender_plural'        => 'العطاءات',
    'type_service_call_plural'  => 'نداءات الخدمة',

    // ── Tenders / Service Calls (shared fields) ──────────────────────────────
    'tenders'               => 'العطاءات',
    'tender'                => 'عطاء',
    'tenders_list'          => 'قائمة العطاءات',
    'tenders_subtitle'      => 'عرض العطاءات وإضافة عطاء جديد',
    'list_tender'           => 'قائمة العطاءات',
    'list_service_call'     => 'قائمة نداءات الخدمة',
    'add_tender'            => 'إضافة عطاء',
    'add_service_call'      => 'إضافة نداء خدمة',
    'add_tender_subtitle'   => 'أدخل بيانات العطاء الجديد',
    'edit_tender'           => 'تعديل عطاء',
    'edit_service_call'     => 'تعديل نداء خدمة',
    ...
    'tender_status_open'    => 'مفتوح',
    'tender_status_closed'  => 'مغلق',
    'tender_status_won'     => 'فائز به',
    'tender_status_lost'    => 'خاسر',
