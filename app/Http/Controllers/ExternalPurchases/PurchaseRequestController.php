...
class PurchaseRequestController extends ModuleController
{
    ...
    public function store(Request $request)
    {
        ...
        $purchaseRequest = PurchaseRequest::create([
            ...
            'shipping_address_line1_en'  => $validated['shipping_address_line1_en'] ?? null,
            'shipping_po_box'            => $validated['shipping_po_box'] ?? null,
            'shipping_postal_code'       => $validated['shipping_postal_code'] ?? null,
            'shipping_city'              => $validated['shipping_city'] ?? null,
            'shipping_city_en'           => $validated['shipping_city_en'] ?? null,
            'shipping_country'           => $validated['shipping_country'] ?? null,
            'shipping_country_en'        => $validated['shipping_country_en'] ?? null,
