...
<form action="<?php echo e(route('tenders.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <?php echo $__env->make('tenders._form', ['customers' => $customers, 'statuses' => $statuses, 'countries' => $countries], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
