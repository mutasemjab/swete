...
<head>
    ...
    <title><?php echo e(__('app.dashboard')); ?> | <?php echo e(__('app.erp_name')); ?></title>
    ...
    <style>
        ...
        .module-card:hover .card-arrow {
            transform: <?php echo e($isRtl ? 'translateX(4px)' : 'translateX(-4px)'); ?>;
            color: #4f46e5;
        }
        .card-icon-wrap {
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-white font-black text-lg leading-none"><?php echo e(__('app.erp_name')); ?></h1>
                    <p class="text-slate-400 text-[11px] mt-0.5 font-medium"><?php echo e(__('app.erp_subtitle')); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <span><?php echo e($isRtl ? 'AR' : 'EN'); ?></span>
                    </button>
                    <div x-show="open"
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="text-start hidden sm:block">
                            <p class="text-white font-semibold text-sm leading-tight"><?php echo e(Auth::user()->name); ?></p>
                            <p class="text-slate-400 text-[11px] font-medium"><?php echo e(Auth::user()->role_label); ?></p>
                        </div>
                    ...
                    <div x-show="open"
                        ...
                        <a href="<?php echo e(route('settings.users.index')); ?>"
                           class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                            ...
                            <?php echo e(__('settings.module_name')); ?>
                        ...
                        <form action="<?php echo e(route('auth.logout')); ?>" method="POST">
                            ...
                            <button type="submit"
                                ...
                                <i class="fa-solid fa-right-from-bracket w-4 text-center text-sm <?php echo e($isRtl ? 'fa-flip-horizontal' : ''); ?>"></i>
        ...
        <div class="hero-text mt-8 mb-7">
            <p class="text-indigo-400 font-semibold text-sm mb-2 flex items-center gap-2">
                ...
                <?php echo e(__('app.welcome_msg')); ?>

            </p>
            <h2 class="text-white font-black text-3xl sm:text-4xl leading-tight">
                <span id="greeting"></span>،
                <span class="text-indigo-300"><?php echo e(explode(' ', Auth::user()->name)[0]); ?></span>
            </h2>
        </div>
    </div>
</header>
...
<main class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        ...
        <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl border border-slate-100 px-5 py-4 flex items-center gap-3.5 shadow-sm"
                 style="animation: fadeUp 0.4s ease-out <?php echo e($i * 60); ?>ms both;">
                <div class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center flex-shrink-0">
                    <i class="fa-solid fa-<?php echo e($stat['icon']); ?> text-slate-500 text-sm"></i>
                </div>
                <div>
                    <p class="text-xl font-black text-slate-800 leading-none"><?php echo e($stat['value']); ?></p>
    ...
    <?php if($myAppointments->isNotEmpty()): ?>
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm mb-8 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
            ...
            <div class="flex-1">
                <h3 class="text-base font-black text-slate-800"><?php echo e(__('crm.my_appointments')); ?></h3>
                <p class="text-xs text-slate-500"><?php echo e(__('crm.my_appointments_hint')); ?></p>
            </div>
            <a href="<?php echo e(route('appointments.index', ['assigned_to' => Auth::id(), 'status' => 'scheduled'])); ?>"
               class="text-xs font-bold text-indigo-600 hover:underline"><?php echo e(__('crm.view_all')); ?></a>
        </div>
        <div class="divide-y divide-slate-100">
            <?php $__currentLoopData = $myAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $overdue = $appt->isOverdue();
                    $today   = $appt->isDueToday();
                ?>
                <div class="px-6 py-3.5 flex items-center gap-4 flex-wrap <?php echo e($today ? 'bg-amber-50' : ($overdue ? 'bg-rose-50' : '')); ?>">
                    <div class="flex-1 min-w-48">
                        <p class="font-bold text-slate-800 text-sm"><?php echo e($appt->title); ?></p>
                        <p class="text-xs text-slate-500 mt-0.5">
                            <?php echo e($appt->type?->localized_name); ?>

                            <?php if($appt->customer): ?> · <?php echo e($appt->customer->localized_name); ?> <?php endif; ?>
                        </p>
                    </div>
                    <span class="text-sm text-slate-600 font-mono" dir="ltr"><?php echo e($appt->appointment_date->format('Y-m-d')); ?></span>
                    <?php if($today): ?>
                        <span class="badge bg-amber-100 text-amber-700"><i class="fa-solid fa-bell"></i> <?php echo e(__('crm.due_today')); ?></span>
                    <?php elseif($overdue): ?>
                        <span class="badge bg-rose-100 text-rose-700"><i class="fa-solid fa-triangle-exclamation"></i> <?php echo e(__('crm.overdue')); ?></span>
                    <?php endif; ?>
                    <form action="<?php echo e(route('appointments.toggle-complete', $appt)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <button type="submit" class="text-xs font-bold text-emerald-600 hover:underline">
                            <i class="fa-solid fa-check"></i> <?php echo e(__('crm.mark_completed')); ?>
    ...
    <div class="flex items-center gap-3 mb-5">
        <h3 class="text-base font-black text-slate-700 uppercase tracking-wider"><?php echo e(__('app.system_modules')); ?></h3>
        <div class="flex-1 h-px bg-slate-200"></div>
        <span class="text-xs font-bold text-slate-400 bg-slate-100 px-2.5 py-1 rounded-full"><?php echo e(count($modules)); ?></span>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e($href); ?>"
               class="module-card <?php echo e(!$routeExists ? 'disabled-card' : ''); ?> block bg-white rounded-2xl border border-slate-200 overflow-hidden group"
               style="animation-delay: <?php echo e($loop->index * 70); ?>ms">
                ...
                <div class="px-6 pt-6 pb-5">
                    ...
                    <p class="text-sm text-slate-400 leading-relaxed"><?php echo e($modDesc); ?></p>
                </div>

                
                <div class="border-t border-slate-100 px-6 py-3.5 flex items-center justify-between bg-slate-50/50">
                    <span class="text-xs font-bold text-slate-400 uppercase tracking-wider">
                        <?php echo e($routeExists ? __('app.open_module') : __('app.coming_soon')); ?>

                    </span>
                    <?php if($routeExists): ?>
                        <i class="fa-solid fa-arrow-<?php echo e($isRtl ? 'left' : 'right'); ?> text-slate-300 text-sm card-arrow"></i>
                    <?php else: ?>
...
<script>
    const greetings = {
        morning:   '<?php echo e(__('app.greeting_morning')); ?>',
        afternoon: '<?php echo e(__('app.greeting_afternoon')); ?>',
        evening:   '<?php echo e(__('app.greeting_evening')); ?>',
        night:     '<?php echo e(__('app.greeting_night')); ?>',
    };
    const isRtl = <?php echo e($isRtl ? 'true' : 'false'); ?>;
...
<?php /**PATH C:\xampp\htdocs\swete\resources\views/dashboard/index.blade.php ENDPATH**/ ?>