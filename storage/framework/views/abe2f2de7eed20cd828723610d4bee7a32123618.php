...
<div class="card mb-5">
    <div class="card-header">
        <h3 class="font-bold text-slate-700 flex items-center gap-2">
            ...
            <?php echo e(__('accounting.group')); ?>

        </h3>
    </div>
    <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
            <label class="form-label"><?php echo e(__('accounting.group_name')); ?> <span class="text-rose-500">*</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $group?->name_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="form-label"><?php echo e(__('accounting.parent_group')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                ...
                <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($parent->id); ?>" <?php if(old('parent_id', $group?->parent_id) == $parent->id): echo 'selected'; endif; ?>><?php echo e($parent->localized_name); ?></option>
        ...
        <div class="flex items-center pt-1">
            <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                ...
                <input type="checkbox" name="status" value="1" class="sr-only peer"
                       <?php if(old('status', $group?->status ?? true)): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\swete\resources\views/accounting/party-groups/_form.blade.php ENDPATH**/ ?>