    ...
    <table class="po-items">
        <thead>
            <tr>
                ...
                <th><?php echo e(__('external_purchases.item_ercd')); ?></th>
                ...
                <th><?php echo e(__('external_purchases.item_features')); ?></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($item->features->pluck('value')->implode(', ')); ?></td>
            </tr>
            ...
            <?php if($purchaseRequest->additionalNotes->isNotEmpty()): ?>
                ...
                <p class="po-notes-body">
                    <?php $__currentLoopData = $purchaseRequest->additionalNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e($note->label); ?>: <?php echo e($note->value); ?><br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </p>
            <?php endif; ?>
...
<?php if($purchaseRequest->supplier?->shipping_instruction): ?>
<div class="po-page instruction-page">
    <div class="instruction-page-header">
        <p class="instruction-title"><?php echo e(__('accounting.supplier_shipping_instruction')); ?></p>
        <p class="instruction-subtitle"><?php echo e($purchaseRequest->supplier->localized_name); ?> — <?php echo e($purchaseRequest->number); ?></p>
    </div>
    <div class="instruction-content">
        <?php echo $purchaseRequest->supplier->shipping_instruction; ?>
