...
<div class="card px-6 py-5 mb-5">
    ...
    <form action="<?php echo e(route('purchase-requests.mark-sent', $purchaseRequest)); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="form-label"><?php echo e(__('external_purchases.email_cc')); ?></label>
            <input type="text" name="cc" value="<?php echo e(old('cc')); ?>" dir="ltr"
                   placeholder="cc1@example.com, cc2@example.com"
                   class="form-input <?php $__errorArgs = ['cc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="form-label"><?php echo e(__('external_purchases.ship_attachments')); ?></label>
            <p class="text-xs text-slate-400 mb-2"><?php echo e(__('external_purchases.ship_attachments_hint')); ?></p>
            <input type="file" name="attachments[]" multiple class="form-input <?php $__errorArgs = ['attachments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
