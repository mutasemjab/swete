...
<div class="card px-6 py-5 mb-5 flex items-center justify-between">
    <p class="text-sm text-slate-600"><?php echo e(__('external_purchases.approved_hint')); ?></p>
    <form action="<?php echo e(route('purchase-requests.mark-sent', $purchaseRequest)); ?>" method="POST">
        <?php echo csrf_field(); ?>
