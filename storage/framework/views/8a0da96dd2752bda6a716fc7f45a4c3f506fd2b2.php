<?php $__env->startSection('title', __('settings.edit_branch')); ?>
<?php $__env->startSection('breadcrumb', __('settings.edit_branch')); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div>
        <h1 class="page-title"><?php echo e(__('settings.edit_branch')); ?></h1>
        <p class="page-subtitle"><?php echo e($branch->localized_name); ?></p>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="name_en" value="<?php echo e(old('name_en', $branch->name_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="phone" value="<?php echo e(old('phone', $branch->phone)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="fax" value="<?php echo e(old('fax', $branch->fax)); ?>" dir="ltr"
    ...
    <div class="card mb-5">
        ...
        <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="address_line1" value="<?php echo e(old('address_line1', $branch->address_line1)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="address_line1_en" value="<?php echo e(old('address_line1_en', $branch->address_line1_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="po_box" value="<?php echo e(old('po_box', $branch->po_box)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="postal_code" value="<?php echo e(old('postal_code', $branch->postal_code)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="city_en" value="<?php echo e(old('city_en', $branch->city_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="country" value="<?php echo e(old('country', $branch->country)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="country_en" value="<?php echo e(old('country_en', $branch->country_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center gap-6">
                <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                    ...
                    <input type="checkbox" name="is_main" value="1" class="sr-only peer"
                           <?php if(old('is_main', $branch->is_main)): echo 'checked'; endif; ?>>
                ...
                <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                    ...
                    <input type="checkbox" name="status" value="1" class="sr-only peer"
                           <?php if(old('status', $branch->status)): echo 'checked'; endif; ?>>
    ...
    <div class="card mb-5 border-rose-200">
        ...
        <div class="px-6 py-5 flex items-center justify-between gap-4">
            <p class="text-xs text-slate-400"><?php echo e(__('app.irreversible')); ?></p>
            <button type="button"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swete\resources\views/settings/branches/edit.blade.php ENDPATH**/ ?>