<?php $__env->startSection('title', __('accounting.suppliers_list')); ?>
<?php $__env->startSection('breadcrumb', __('accounting.suppliers')); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div>
        <h1 class="page-title"><?php echo e(__('accounting.suppliers_list')); ?></h1>
        <p class="page-subtitle"><?php echo e(__('accounting.suppliers_subtitle')); ?></p>
    </div>
    <a href="<?php echo e(route('accounting.suppliers.create')); ?>" class="btn-primary">
        <i class="fa-solid fa-plus"></i>
        <?php echo e(__('accounting.add_supplier')); ?>
...
<div class="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    <div class="card px-5 py-4 flex items-center gap-4">
        ...
        <div>
            <p class="text-2xl font-black text-slate-800"><?php echo e($suppliers->total()); ?></p>
            <p class="text-xs text-slate-500 font-medium mt-0.5"><?php echo e(__('accounting.total_suppliers')); ?></p>
        </div>
    </div>
</div>

<form method="GET" action="<?php echo e(route('accounting.suppliers.index')); ?>" class="card px-5 py-4 mb-4 flex flex-wrap gap-3">
...
<div class="card overflow-hidden">
    <?php if($suppliers->isEmpty()): ?>
        <div class="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p class="text-slate-800 font-bold text-lg"><?php echo e(__('accounting.no_suppliers')); ?></p>
            <a href="<?php echo e(route('accounting.suppliers.create')); ?>" class="btn-primary mt-5">
                <i class="fa-solid fa-plus"></i>
                <?php echo e(__('accounting.add_first_supplier')); ?>
    ...
    <?php else: ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-5 py-4">
                            <span class="font-mono font-bold text-slate-700 bg-slate-100 px-2 py-1 rounded-lg text-sm"><?php echo e($supplier->code); ?></span>
                        </td>
                        <td class="px-5 py-4"><p class="font-bold text-slate-800"><?php echo e($supplier->localized_name); ?></p></td>
                        <td class="px-5 py-4 hidden md:table-cell text-sm text-slate-600"><?php echo e($supplier->group?->localized_name ?? '—'); ?></td>
                        <td class="px-5 py-4 hidden lg:table-cell text-sm text-slate-600" dir="ltr"><?php echo e($supplier->phone ?? '—'); ?></td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <button type="button" title="<?php echo e(__('app.delete')); ?>"
                                        @click="$dispatch('delete-confirm', { action: '<?php echo e(route('accounting.suppliers.destroy', $supplier)); ?>', message: '<?php echo e(__('app.delete_confirm_msg')); ?>' })"
        ...
        <div class="px-5 py-4 border-t border-slate-100 flex items-center justify-between gap-4 flex-wrap">
            <p class="text-sm text-slate-500">
                <?php echo e(__('app.showing')); ?> <span class="font-bold text-slate-700"><?php echo e($suppliers->firstItem()); ?></span>
                <?php echo e(__('app.to')); ?> <span class="font-bold text-slate-700"><?php echo e($suppliers->lastItem()); ?></span>
                <?php echo e(__('app.of')); ?> <span class="font-bold text-slate-700"><?php echo e($suppliers->total()); ?></span>
            ...
            <div class="flex gap-1">
                ...
                <?php else: ?>
                    <a href="<?php echo e($suppliers->previousPageUrl()); ?>" class="btn-secondary btn-sm"><?php echo e(__('app.previous')); ?></a>
                <?php endif; ?>
                <?php if($suppliers->hasMorePages()): ?>
                    <a href="<?php echo e($suppliers->nextPageUrl()); ?>" class="btn-primary btn-sm"><?php echo e(__('app.next')); ?></a>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swete\resources\views/accounting/suppliers/index.blade.php ENDPATH**/ ?>