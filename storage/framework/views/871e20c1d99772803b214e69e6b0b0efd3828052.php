...
<div x-data="{ tab: '<?php echo e($tab === 'by_me' ? 'by_me' : 'for_me'); ?>' }">
    ...
    <div class="flex gap-2 mb-6">
        <button type="button" @click="tab = 'for_me'"
            ...
            <?php $forMeTotal = $pendingForMe->count() + $pendingPurchaseRequestApprovals->count() + $pendingReminders->count(); ?>
            <?php if($forMeTotal): ?>
                <span class="ms-1.5 px-1.5 py-0.5 rounded-md text-[11px]" :class="tab === 'for_me' ? 'bg-white/20' : 'bg-rose-100 text-rose-600'"><?php echo e($forMeTotal); ?></span>
            <?php endif; ?>
        </button>
    ...
    <div x-show="tab === 'for_me'">
        ...
        <?php if($pendingPurchaseRequestApprovals->isNotEmpty()): ?>
        <div class="card overflow-hidden mb-5">
            <div class="card-header">
                <h3 class="font-bold text-slate-700"><?php echo e(__('approvals.pending_purchase_requests')); ?></h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $pendingPurchaseRequestApprovals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prApproval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $pr = $prApproval->purchaseRequest; ?>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-5 py-4 font-bold text-slate-800">
                                <a href="<?php echo e(route('purchase-requests.show', $pr)); ?>" class="hover:text-indigo-600 hover:underline"><?php echo e($pr->number); ?></a>
                            </td>
                            <td class="px-5 py-4 text-sm text-slate-600"><?php echo e($pr->creator?->name); ?></td>
                            <td class="px-5 py-4 text-sm text-slate-500"><?php echo e($prApproval->created_at->diffForHumans()); ?></td>
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <form action="<?php echo e(route('purchase-requests.approve', $pr)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form action="<?php echo e(route('purchase-requests.reject', $pr)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="card overflow-hidden mb-5">
            <div class="card-header">
                <h3 class="font-bold text-slate-700"><?php echo e(__('approvals.pending_purchase_request_reminders')); ?></h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-slate-50 border-b border-slate-100">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $pendingReminders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reminder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-5 py-4 font-bold text-slate-800">
                                <a href="<?php echo e(route('purchase-request-reminders.show', $reminder)); ?>" class="hover:text-indigo-600 hover:underline"><?php echo e($reminder->project?->number); ?> — <?php echo e($reminder->project?->localized_title); ?></a>
                            </td>
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('purchase-request-reminders.show', $reminder)); ?>" class="btn-secondary btn-sm">
                                        <i class="fa-solid fa-eye"></i> <?php echo e(__('app.view')); ?>

                                    </a>
                                    <a href="<?php echo e(route('purchase-requests.create', ['reminder_id' => $reminder->id])); ?>" class="btn-primary btn-sm">
                                        <i class="fa-solid fa-plus"></i> <?php echo e(__('tenders.reminder_create_pr')); ?>
