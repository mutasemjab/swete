<?php $__env->startSection('title', __('settings.add_governorate')); ?>
<?php $__env->startSection('breadcrumb', __('settings.add_governorate')); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div>
        <h1 class="page-title"><?php echo e(__('settings.add_governorate')); ?></h1>
    </div>
...
<form action="<?php echo e(route('settings.governorates.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="card mb-5">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swete\resources\views/settings/governorates/create.blade.php ENDPATH**/ ?>