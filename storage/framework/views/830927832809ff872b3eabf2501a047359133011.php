...
<div class="card mb-5">
    <div class="card-header">
        <h3 class="font-bold text-slate-700 flex items-center gap-2">
            <i class="fa-solid fa-tags text-rose-500 text-sm"></i>
            <?php echo e(__('crm.appointment_type')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $type?->name_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center">
            <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                ...
                <input type="checkbox" name="status" value="1" class="sr-only peer" <?php if(old('status', $type->status ?? true)): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\swete\resources\views/crm/appointment-types/_form.blade.php ENDPATH**/ ?>