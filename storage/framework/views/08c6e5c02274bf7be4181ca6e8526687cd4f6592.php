        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <?php $readyDateToday = $pr->ready_date && $pr->ready_date->isToday() && $pr->status !== 'shipped'; ?>
                    <tr class="transition-colors group <?php echo e($readyDateToday ? 'bg-amber-50 hover:bg-amber-100' : 'hover:bg-slate-50/50'); ?>">
                        <td class="px-5 py-4">
                            ...
                            <?php if($readyDateToday): ?>
                                <span class="badge bg-amber-100 text-amber-700 ms-1" title="<?php echo e(__('external_purchases.ready_date_today_hint')); ?>">
                                    <i class="fa-solid fa-triangle-exclamation"></i>
                                    <?php echo e(__('external_purchases.ready_date_today')); ?>
