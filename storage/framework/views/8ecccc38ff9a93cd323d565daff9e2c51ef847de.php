...
<div class="card mb-5">
    ...
    <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
            ...
            <input type="text" name="name" value="<?php echo e(old('name', $scope?->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $scope?->name_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center">
            <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                ...
                <input type="checkbox" name="status" value="1" class="sr-only peer" <?php if(old('status', $scope->status ?? true)): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\swete\resources\views/tenders/quote-supply-scopes/_form.blade.php ENDPATH**/ ?>