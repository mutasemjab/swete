...
<div class="card mb-5">
    <div class="card-header">
        <h3 class="font-bold text-slate-700 flex items-center gap-2">
            ...
            <?php echo e(__('warehouse.unit')); ?>

        </h3>
    </div>
    <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
            <label class="form-label"><?php echo e(__('warehouse.unit_name')); ?> <span class="text-rose-500">*</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $unit?->name_en)); ?>" dir="ltr"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label class="form-label"><?php echo e(__('warehouse.unit_symbol')); ?></label>
            <input type="text" name="symbol" value="<?php echo e(old('symbol', $unit?->symbol)); ?>" dir="ltr"
                   class="form-input <?php $__errorArgs = ['symbol'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <div class="flex items-center pt-7">
            <label class="relative inline-flex items-center cursor-pointer" dir="ltr">
                ...
                <input type="checkbox" name="status" value="1" class="sr-only peer"
                       <?php if(old('status', $unit?->status ?? true)): echo 'checked'; endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\swete\resources\views/warehouse/units/_form.blade.php ENDPATH**/ ?>